...
export interface BaseCreateOrUpdateFormProps<T, CreateRequest, UpdateRequest, CreateResponse extends BaseResponse = any, UpdateResponse extends BaseResponse = any> {
