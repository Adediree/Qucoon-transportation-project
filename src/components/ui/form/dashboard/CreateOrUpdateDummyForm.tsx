...
const CreateOrUpdateDummyForm = <T extends DummyFormRequest>({
    ...
    return (
        ...
        >
            ...
            <BaseDatePicker formik={formik} name={"dummyDateMoved"} label={"Dummy Date Moved"}/>
            ...
            <BasePhoneNumberInput formik={formik} customFullPhoneNumberInputName={"dummyPhone"}
                                  label={"Dummy Phone"}/>
            <ModernSelect label={"Dummy Rating"}
                          selectOptions={ratingSelectOptions}/>

            <ModernSelect label={"Pick yo"} error={"Nigga"} selectOptions={[
