...
import {useInitiatePasswordResetMutation, useResendOtpMutation} from "@/services/authenticationService";
...
const ResetPasswordForm = (props: React.DetailedHTMLProps<React.FormHTMLAttributes<HTMLFormElement>, HTMLFormElement>) => {
    ...
    const initialValues: InitiatePasswordResetRequest = {...initiatePasswordResetRequestInit, userEmail: ""};
        ...
        if (BaseUtil.isApiResponseSuccessful(response)) {
            ...
            showOtp({
                ...
                onValidOtpEntered: async (otp) => {
                    dispatch(authStore.mutation.setCompletePasswordResetFlowPayload({
                        ...authState?.completePasswordResetFlowPayload, ...request,
                        otp: otp
                    }))
